...
function Header() {
  ...
  return (
    <header className="flex items-center justify-between px-4 w-full md:px-8 h-20 bg-darkBrown text-white">
      <h1 className="text-2xl font-bold font-heading text-orange">ROASTERS</h1>
